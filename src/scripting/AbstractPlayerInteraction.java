...
//        System.err.println(curtime);
    ...
    public final void summonMsg(final int type) {
        ...
        c.getSession().write(UIPacket.summonMessage(true, type, ""));
    }
    ...
    public final void summonMsg(final String msg) {
        ...
        c.getSession().write(UIPacket.summonMessage(false, 0, msg));
    }
...
//        map.setChangeableMobUsing(true);
    ...
    public void getNPCDirectionEffect(int npcid, String data, int value, int x, int y) {
        ...
        c.getSession().write(CField.UIPacket.getDirectionEffect(data, value, x, y, npc.getObjectId()));
    }
