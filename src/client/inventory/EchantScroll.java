...
public enum EchantScroll {
    ...
    攻擊力_力量_100("攻擊力(力量)", 100, 0, 155, EchantEquipStat.STR.getValue() | EchantEquipStat.WATK.getValue(), new int[]{1, 3}),
    攻擊力_力量_70("攻擊力(力量)", 70, 1, 200, EchantEquipStat.STR.getValue() | EchantEquipStat.WATK.getValue(), new int[]{2, 5}),
    攻擊力_力量_30("攻擊力(力量)", 30, 2, 240, EchantEquipStat.STR.getValue() | EchantEquipStat.WATK.getValue(), new int[]{3, 7}),
    攻擊力_力量_15("攻擊力(力量)", 15, 3, 290, EchantEquipStat.STR.getValue() | EchantEquipStat.WATK.getValue(), new int[]{4, 9}),
    ...
    攻擊力_體力_100("攻擊力(體力)", 100, 0, 155, EchantEquipStat.MHP.getValue() | EchantEquipStat.WATK.getValue(), new int[]{1, 3}),
    攻擊力_體力_70("攻擊力(體力)", 70, 1, 200, EchantEquipStat.MHP.getValue() | EchantEquipStat.WATK.getValue(), new int[]{2, 5}),
    攻擊力_體力_30("攻擊力(體力)", 30, 2, 240, EchantEquipStat.MHP.getValue() | EchantEquipStat.WATK.getValue(), new int[]{3, 7}),
    攻擊力_體力_15("攻擊力(體力)", 15, 3, 290, EchantEquipStat.MHP.getValue() | EchantEquipStat.WATK.getValue(), new int[]{4, 9}),
    攻擊力_100("攻擊力", 100, 0, 155, EchantEquipStat.WATK.getValue(), new int[]{1}),
    攻擊力_70("攻擊力", 70, 1, 200, EchantEquipStat.WATK.getValue(), new int[]{2}),
    攻擊力_30("攻擊力", 30, 2, 240, EchantEquipStat.WATK.getValue(), new int[]{3}),
    ...
    體力_100("體力", 100, 0, 155, EchantEquipStat.MHP.getValue(), new int[]{3}),
    體力_70("體力", 70, 1, 200, EchantEquipStat.MHP.getValue(), new int[]{4}),
    體力_30("體力", 30, 2, 240, EchantEquipStat.MHP.getValue(), new int[]{7}),
